...
#define STATUSBAR "wiredwmblocks"
...
static const char *voldowncmd[] = { "amixer", "-q", "set", "Master", "5%-", "unmute", NULL, "pkill", "-RTMIN+10", "wiredwmblocks", NULL };
static const char *volupcmd[] = { "amixer", "-q", "set", "Master", "5%+", "unmute", NULL, "pkill", "-RTMIN+10", "wiredwmblocks", NULL };
static const char *updatevol[] = { "pkill", "-RTMIN+10", "wiredwmblocks", NULL };
